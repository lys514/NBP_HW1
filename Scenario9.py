...
if __name__ == "__main__":
    ...
    serverName = ["s16c3b1ae271", "s16c3b1ae970"]
    ...
    lbInstance = createLoadBalancerInstance(instNoList, "HTTP", 80, 80, "/index.html", "instLB", "RR", "scenario9 LB")
    domain_name = lbInstance["domainName"]
